...
export const IntroSection = () => {
    ...
    return <section className="relative max-w-[768px] text-woodland-green dark:text-corn-silk font-secondary mx-auto">
        <p className="text-sm dark:text-corn-silk/70">Hi, the name is</p>
        <h1 className="text-3xl font-display font-bold">Abel Mesele</h1>

        <Icon className="absolute top-5 right-5 cursor-pointer" onClick={() => setTheme(prevTheme => prevTheme === "dark" ? "light" : "dark")} />
